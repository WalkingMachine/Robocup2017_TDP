...
This year we are planning to implement gesture recognition for the restaurant challenge and plannar and object segmentation to detect unknowned objects mainly for the storing groceries challenge. We'll also be working on our Natural Language Understanding package to add more features for the more complex challenges in the GPSR. \\ 
